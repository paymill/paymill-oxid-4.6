...
$aLang = array(
	...
	"PAGE_CHECKOUT_PAYMENT_VALIDUNTIL" => "G&Atilde;&frac14;ltig bis",
	...
	"PAGE_CHECKOUT_PAYMENT_MONTH_MAR" => "M&Atilde;&curren;rz",
	...
	"PAYMILL_VALIDATION_CARDNUMBER" => "Bitte geben Sie eine g&Atilde;&frac14;ltige Kreditkartennummer ein.",
	"PAYMILL_VALIDATION_ACCOUNTNUMBER" => "Bitte geben Sie eine g&Atilde;&frac14;ltige Kontonummer ein",
	"PAYMILL_VALIDATION_BANKCODE" => "Bitte geben Sie eine g&Atilde;&frac14;ltige Bankleitzahl an",
	"PAYMILL_VALIDATION_IBAN" => "Bitte geben Sie eine g&Atilde;&frac14;ltige IBAN an.",
	"PAYMILL_VALIDATION_BIC" => "Bitte geben Sie eine g&Atilde;&frac14;ltige BIC an.",
	"PAYMILL_VALIDATION_EXP" => "Ung&Atilde;&frac14;ltiges Ablaufdatum",
	"PAYMILL_VALIDATION_CVC" => "Ung&Atilde;&frac14;ltige CVC",
	...
	"PAGE_CHECKOUT_PAYMENT_CC_TOOLTIP" => "Hinter dem CVV-Code bzw. CVC verbirgt sich ein Sicherheitsmerkmal von Kreditkarten, &Atilde;&frac14;blicherweise handelt es sich dabei um eine drei- bis vierstelligen Nummer. Der CVV-Code befindet sich auf VISA-Kreditkarten. Der gleiche Code ist auch auf MasterCard-Kreditkarten zu finden, hier allerdings unter dem Namen CVC. Die Abk&Atilde;&frac14;rzung CVC steht dabei f&Atilde;&frac14;r Card Validation Code. Bei VISA wird der Code als Card Verification Value-Code bezeichnet. &Atilde;„hnlich wie bei Mastercard und VISA gibt es auch bei Diners Club, Discover und JCB eine dreistellige Nummer, die meist auf der R&Atilde;&frac14;ckseite der Karte zu finden ist. Bei Maestro-Karten gibt es mit und ohne dreistelligen CVV. Wird eine Maestro-Karte ohne CVV verwendet kann einfach 000 eingetragen werden. American Express verwendet die CID (Card Identification Number). Dabei handelt es sich um eine vierstellige Nummer, die meist auf der Vorderseite der Karte, rechts oberhalb der Kartennummer zu finden ist.",
	...
	"PAYMILL_field_invalid_card_number" => "Bitte geben Sie eine g&Atilde;&frac14;ltige Kreditkartennummer ein.",
	"PAYMILL_field_invalid_card_exp_year" => "Invalid Expiry Year",
	"PAYMILL_field_invalid_card_exp_month" => "Invalid Expiry Month",
	"PAYMILL_field_invalid_card_exp" => "Ung&Atilde;&frac14;ltiges Ablaufdatum",
	"PAYMILL_field_invalid_card_cvc" => "Ung&Atilde;&frac14;ltige CVC",
