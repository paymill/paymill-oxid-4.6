...
$aLang = array(
    ...
    "PAGE_CHECKOUT_PAYMENT_IFRAME_CHANGE" => "Changer",
    "PAYMILL_IFRAME_OPTION_LANG" => "fr",
    ...
    "PAYMILL_field_invalid_card_number" => "Veuillez saisir un num&eacute;ro de carte de cr&eacute;dit valide.",
